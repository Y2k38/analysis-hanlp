...
import org.elasticsearch.plugin.analysis.hanlp.core.PorterStemmer;
import org.elasticsearch.plugin.analysis.hanlp.core.SegmentWrapper;
import org.elasticsearch.plugin.analysis.hanlp.dic.CoreStopWordDictionary;
...
public class BaseTokenizer extends Tokenizer {
     ...
     */
    public BaseTokenizer(Segment segment, Configuration configuration) {
